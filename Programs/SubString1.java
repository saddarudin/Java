...
Given a string, , and an integer, , complete the function so that it finds
...
We then return the first (lexicographically smallest) substring and the
last (lexicographically largest) substring as two newline-separated values (i.e., ava\nwel).
